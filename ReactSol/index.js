  ...
  return(
    <div className="center-align">
      ...
      <div className="dual-container">
        <Length title="Break Length" changeTime={changeTime} type="break-label" time={breakTime} formatTime={formatTime}/>
        <Length title="session" changeTime={changeTime} type="session" time={sessionTime} formatTime={formatTime}/>
      </div>
